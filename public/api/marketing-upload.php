...
$fileBaseName = 'marketing-popup';
$targetFileName = $fileBaseName . '.jpg';
...
foreach (glob($photosDir . DIRECTORY_SEPARATOR . $fileBaseName . '.*') as $existingFile) {
    if ($existingFile !== $targetPath && is_file($existingFile)) {
        @unlink($existingFile);
    }
}

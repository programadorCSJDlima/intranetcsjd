...
export default function ModalViewMenu({ isOpen, onClose, img, title, link, showTitle = true }) {
  ...
  const content = (
    <div className="relative w-full max-w-2xl mx-auto">
      ...
      {showTitle && title && (
        <div className="absolute bottom-0 w-full bg-black bg-opacity-75 px-4 py-2 text-white rounded-b-2xl">
          {title}
        </div>
      )}
      <button
